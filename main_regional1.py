...
def main():
    """
    Função principal que executa a raspagem dos primeiros 100 portais regionais.
    """
    try:
        ...
        relatorio = f"""
        Relatório de Execução (Regionais - Parte 1):
        --------------------------------------------
        ...
        print(f"Erro durante a execução da main_regional1: {e}")
