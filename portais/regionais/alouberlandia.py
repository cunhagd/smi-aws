...
def formatar_data(data_str):
    try:
        data_str = data_str.replace('Posted on ', '').strip()
        meses = {
...
def extrair_dados_noticia(url):
    ...
    autor_texto = "Redação Betan City"

    data = soup.find('div', {'class': 'post-data-text'})
