...
def extrair_dados_noticia(url):
    ...
    autor_texto = "Redação TV Paraníba"

    data = soup.select_one('section.entry-meta p')
    data_texto = formatar_data(data.get_text(strip=True)) if data else "Data não encontrada"

    paragrafos = soup.select('section.entry-content p')
