...
def extrair_dados_noticia(url):
    ...
    autor = soup.select_one('span.cm-author a')
    autor_texto = autor.get_text(strip=True) if autor else "Redação Itabira Notícias"
