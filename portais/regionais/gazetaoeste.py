...
def extrair_links(html):
    ...
    for link in soup.find_all("a", href=True):
        ...
        if (
            url.count('-') > 2
            and '/vagas-de-emprego/' not in url
            and '/artigos/' not in url
            and url.startswith("https://g37.com.br/")
        ):
...
def extrair_dados_noticia(url):
    ...
    autor = soup.select_one("h3.author-name a")
