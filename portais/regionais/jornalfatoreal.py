...
def extrair_dados_noticia(url):
    ...
    autor_texto = "Redação Jornal Fato Real"

    data = soup.select_one(".jeg_meta_date a")
    data_texto = formatar_data(data.get_text(strip=True)) if data else "Data não encontrada"

    corpo = soup.select("div.entry-content.no-share p")
