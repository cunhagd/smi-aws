...
def extrair_dados_noticia(url):
    ...
    autor = soup.select_one("li.author")
    data = soup.select_one(".meta-info li:nth-child(2)")
    corpo = soup.select("div.context p")
