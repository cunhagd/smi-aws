...
def extrair_dados_noticia(url):
    ...
    autor = soup.find('span', class_='author vcard').find('a', class_='url fn n')
    autor_texto = autor.get_text(strip=True) if autor == "admin" else "Redação Folha Centro Sul"

    data = soup.select_one('time', class_='entry-date published updated')
