...
def extrair_dados_noticia(url):
    ...
    autor_texto = autor.get_text(strip=True) if autor else "Redação ABCD Maior"
    if autor_texto.lower() == "admin" or autor_texto.lower() == "admin1":
        autor_texto = "Redação ABCD Maior"
