...
def extrair_dados_noticia(url):
    ...
    autor = soup.select_one("p.content-publication-data__from")
    ...
    if autor:
        ...
        autor_texto = "Redação G1 Triângulo Mineiro"
...
def main():
    nome_portal = "G1 Triângulo Mineiro"
    acesso = AcessarCodigoFonte(url)
    html = acesso.acessar()
