...
def formatar_data(data_str):
    try:
        ...
        data_obj = datetime.strptime(data_str, "%d/%m/%Y às %H:%M")
...
def extrair_dados_noticia(url):
    ...
    autor_texto = autor["content"] if autor else "Redação Jornal do Brasil"

    data = soup.select_one("p.publicacao")
