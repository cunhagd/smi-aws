...
def extrair_dados_noticia(url):
    ...
    autor = soup.select_one(".elementor-post-info__item--type-author")
    autor_texto = autor.get_text(strip=True) if autor else "Redação O Popular"

    data = soup.select_one(".elementor-post-info__item--type-date time")
