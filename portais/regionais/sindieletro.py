...
def extrair_dados_noticia(url):
    ...
    titulo = soup.select_one("div.module-blog.module-blog-show h1")
    titulo_texto = titulo.get_text(strip=True) if titulo else "Título não encontrado"

    autor_texto = "Redação SindiEletro"

    data = soup.select_one("div.post-datetime a")
