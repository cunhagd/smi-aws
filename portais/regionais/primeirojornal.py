...
def extrair_dados_noticia(url):
    ...
    autor = soup.select_one("div.tdb-author-name-wrap a.tdb-author-name")
    autor_texto = autor.get_text(strip=True) if autor else "Redação Primeiro Jornal"
