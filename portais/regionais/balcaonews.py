...
def extrair_dados_noticia(url):
    ...
    autor = soup.select_one('span.meta-item.post-author.has-img a')
    autor_texto = autor.get_text(strip=True) if autor else "Redação Balcão News"
    ...
    corpo = soup.select("div.post-content.cf.entry-content.content-spacious p")
