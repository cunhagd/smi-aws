...
def extrair_dados_noticia(url):
    ...
    titulo = soup.select_one("h1.my-3")
    titulo_texto = titulo.get_text(strip=True) if titulo else "Título não encontrado"

    autor_texto = "Redação Vio Mundo"
    if ":" in titulo_texto:
        autor_texto = titulo_texto.split(":")[0].strip()
