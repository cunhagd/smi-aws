...
def extrair_dados_noticia(url):
    ...
    autor = soup.select_one(".td-post-author-name a")
    autor_texto = autor.get_text(strip=True) if autor and autor.get_text(strip=True) else "Redação Opinião Caeté"

    data = soup.select_one(".td-post-date time")
