...
def extrair_dados_noticia(url):
    ...
    autor_texto = "Redação TV Rede Mais"

    data = soup.find('meta', {'property': 'og:updated_time'})
    data_texto = formatar_data(data['content']) if data else "Data não encontrada"

    paragrafos = soup.select('div.col-md-8.mx-auto.body-blog-single p')
