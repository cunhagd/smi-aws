...
portal_chave = 'diarioparademinas'
...
def extrair_dados_noticia(url):
    ...
    autor_texto = autor.get_text(strip=True) if autor and autor.get_text(strip=True) else "Redação Diário de Pará de Minas"
...
def main():
    nome_portal = "Diário Pará de Minas"
    acesso = AcessarCodigoFonte(url)
    html = acesso.acessar()
