...
portal_chave = 'itatiaia_ultimas'
dominio_principal = "https://www.itatiaia.com.br/"
urls = [
    "https://www.itatiaia.com.br/",
    "https://www.itatiaia.com.br/ultimas-noticias",
    "https://www.itatiaia.com.br/saude",
    "https://www.itatiaia.com.br/politica",
    "https://www.itatiaia.com.br/brasil",
    "https://www.itatiaia.com.br/economia",
    "https://www.itatiaia.com.br/financas"
]
...
def extrair_links(html):
    ...
    for link in soup.find_all("a", href=True):
        ...
        if (
            ...
            or f"/{ano_atual}/{mes_atual:02}/{dia_atual}/" in url
...
def extrair_dados_noticia(url):
    ...
    titulo = soup.select_one("h1.Page-headline")
    autor = soup.select_one("div.Page-authors")
    data = soup.select_one("div.Page-datePublished")
    corpo = soup.select("div.RichTextArticleBody.RichTextBody p")
