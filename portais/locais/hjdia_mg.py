...
def extrair_dados_noticia(url):
    ...
    autor_texto = autor["content"].replace("Do ", "").strip() if autor else "Redação Hoje em Dia"
    ...
    corpo = soup.select("p.styled__Paragraph-sc-fdx3oi-6.eValfS")
