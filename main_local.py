...
def importar_portais(base_diretorio, categoria="locais"):
    """
    Importa dinamicamente todos os módulos Python dentro de `portais/locais`.
    """
    portais = []
    # Define o caminho específico para portais/locais a partir do base_diretorio
    ...
    # Percorre apenas o diretório portais/locais
...
def main():
    """
    Função principal que executa a raspagem de notícias locais.
    """
    try:
        ...
        # Importa os portais da categoria "locais"
        portais = importar_portais(base_diretorio, "locais")
        ...
        print(f"Erro durante a execução da main_local: {e}")
